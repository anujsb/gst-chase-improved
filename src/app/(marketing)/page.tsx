// src/app/(marketing)/page.tsx  →  accessible at /
// NOTE: This file should NOT exist if root page.tsx redirects to /dashboard.
// The landing page lives at /landing or is the root before auth is added.
// For now root redirects to /dashboard — keep this file but it won't be served.
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-8 pt-24 pb-16 text-center">
        <h1 className="text-5xl font-semibold text-zinc-900 leading-tight tracking-tight mb-6">
          GST filing,<br /><span className="text-zinc-400">without the chaos.</span>
        </h1>
        <p className="text-lg text-zinc-500 max-w-xl mx-auto mb-10">
          Drop invoices. AI reads every PDF and photo, reconciles against GSTR-2B, flags mismatches, pre-fills GSTR-3B.
        </p>
      ...
      <div className="max-w-4xl mx-auto px-8 pb-24 grid grid-cols-3 gap-4">
        {[
          { icon: "📄", title: "AI Invoice OCR", desc: "Drop photos or PDFs. Gemini extracts invoice number, GSTIN, date, and tax amounts." },
          { icon: "🔁", title: "GSTR-2B Reconciliation", desc: "Green, yellow, red. Every invoice matched against supplier-reported data." },
          { icon: "📊", title: "GSTR-3B Export", desc: "ITC figures auto-calculated. Export as Excel or JSON for portal upload." },
        ].map((f) => (
